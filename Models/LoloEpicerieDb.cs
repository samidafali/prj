...
{
    public class LoloEpicerieDb : DbContext
    {
        ...
        public LoloEpicerieDb()
        {
            Database.SetInitializer(new MigrateDatabaseToLatestVersion<ProjetEpîcerie.Models.LoloEpicerieDb, ProjetEpîcerie.Migrations.Configuration>());
        }
